...
profile:
  ...
  address: > 
    ...
    <p><button onclick=window.open("https://econdojo.github.io/assets/img/paypal.jpg","demo","width=500,height=500,left=150,top=200,toolbar=0,status=0,")>💚sponsor💚</button></p>
...
Please send an email to me if you have any difficulty with links or downloads. Feel free to the open-source content of this homepage by clicking the button below.
<p>
  <button onclick=window.open("https://econdojo.github.io/assets/img/paypal.jpg","demo","width=500,height=500,left=150,top=200,toolbar=0,status=0,")>💚sponsor💚</button>
</p>
