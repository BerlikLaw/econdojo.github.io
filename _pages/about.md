...
profile:
  ...
  address: > 
    ...
    <br><button onclick=window.open("https://econdojo.github.io/assets/img/paypal.jpg","demo","width=500,height=500,left=150,top=200,toolbar=0,status=0,")>💚 Sponsor</button></p>
