...
\begin{itemize}
  \item A1. $$\mathbb{E}_{P_{\theta}}[\epsilon|X]=0$$.
  \item A2. There exists no $$A\subseteq\mathbb{R}^k$$ such that $$P_X(A)=1$$ and $$A$$ is a proper linear subspace of $$\mathbb{R}^k$$.
\end{itemize}
...
\begin{itemize}
  \item B1. $$\mathbb{E}_{P_{\theta}}[\epsilon X]=0$$.
  \item B2. $$\mathbb{E}_{P_{\theta}}[XX']$$ is nonsingular.
\end{itemize}
